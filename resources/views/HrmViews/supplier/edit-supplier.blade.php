                    ...
                    <div class="col-lg-9">
                        {!! Form::model( $supplier, array( 'method'=>'put', 'route'=> array( 'supplier.update', $supplier->id ),'id'=>'form','files'=>true ) ) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                {{ Html::image($supplier->img, null, array('id' => 'preview-container','class' => 'img-responsive img-thumbnail')) }}
                    ...
                    <div class="col-lg-3">
                        <div class="panel panel-primary">
	                        ...
	                        <div class="panel-footer">
                                <div class="buttons">
                                    <a href="{{ route('supplier.index') }}" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp Go Back</a>
                                    <a href="{{ route( 'supplier.show', array( 'id'=> $supplier->id ) ) }}" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> Show</a>
                                </div>

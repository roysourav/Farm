                    ...
                    <div class="col-lg-9">
                        <?php echo Form::model( $supplier, array( 'method'=>'put', 'route'=> array( 'supplier.update', $supplier->id ),'id'=>'form','files'=>true ) ); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo e(Html::image($supplier->img, null, array('id' => 'preview-container','class' => 'img-responsive img-thumbnail'))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                'seed' => 'Seed Supplier',
                                                 ...
                                                 $supplier->cat, ['class' => 'form-control select','required'=>''] )); ?>
                    ...
                    <div class="col-lg-3">
                        <div class="panel panel-primary">
	                        ...
	                        <div class="panel-footer">
                                <div class="buttons">
                                    <a href="<?php echo e(route('supplier.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp Go Back</a>
                                    <a href="<?php echo e(route( 'supplier.show', array( 'id'=> $supplier->id ) )); ?>" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> Show</a>
                                </div>

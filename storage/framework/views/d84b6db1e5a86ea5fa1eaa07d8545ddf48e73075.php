...
<head>
    ...
    <!-- Skin blue css-->
    <?php echo Html::style( 'assets/css/skin-blue.min.css' ); ?>
...
<body class="hold-transition login-page" style="background-image: url(<?php echo e(URL::asset('images/cow-banner.jpg')); ?>); background-size:cover; background-position:top;">
    <div class="login-box">

...
<section class="content-header">
    <h1>Update Cow Seller: <?php echo e($cowseller->name); ?></h1>
</section>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-9">
                        <?php echo Form::model( $cowseller, array( 'method'=>'put', 'route'=> array( 'cowseller.update', $cowseller->id ),'id'=>'form','files'=>true ) ); ?>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <?php echo Form::text( 'account_no', null, array( 'class'=>'form-control','placeholder'=>'Enter Bank Account No.','data-parsley-type'=>'number'  ) ); ?> 
                            ...
                            <div class="col-sm-9">
                                <div class="buttons">
                                    ...
                                    <?php echo Form::submit( 'Update Cow Seller', array( 'class'=>'btn btn-warning' ) ); ?>
                    ...
                    <div class="col-lg-3">
                        <div class="panel panel-primary">
	                        ...
	                        <div class="panel-footer">
                                <div class="buttons">
                                    <a href="<?php echo e(route('cowseller.index')); ?>" class="btn btn-primary">Go Back</a>
                                    <a href="<?php echo e(route( 'cowseller.show', array( 'id'=> $cowseller->id ) )); ?>" class="btn btn-success">Show</a>
                                </div>

                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php foreach( $customers as $customer ): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="label label-success" href="<?php echo e(route( 'customer.show', array( 'id'=> $customer->id ) )); ?>">Show</a>


                                                <a class="label label-warning" href="<?php echo e(route( 'customer.edit', array( 'id'=> $customer->id ) )); ?>">Edit</a>

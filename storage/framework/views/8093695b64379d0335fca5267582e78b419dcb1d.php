                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <?php echo Form::model( $doctor, array( 'method'=>'put', 'route'=> array( 'doctor.update', $doctor->id ),'id'=>'form','files'=>true ) ); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo e(Html::image($doctor->img, null, array('id' => 'preview-container','class' => 'img-responsive img-thumbnail'))); ?>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-footer">
                                        <div class="buttons">
                                            <a href="<?php echo e(route('doctor.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp Go Back</a>
                                            <a href="<?php echo e(route( 'doctor.show', array( 'id'=> $doctor->id ) )); ?>" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> Show</a>
                                        </div>

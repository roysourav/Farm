	...
	<div class="row">
        ...
        <div class="col-lg-3">
            <div class="panel panel-primary m_top_25">
                ...
                <div class="panel-body">
                    <h5>Created At:</h5>
                    <p><?php echo Carbon\Carbon::parse($dead_cow->created_at)->format('jS M Y , h:i A'); ?></p>
                                
                    <h5>Last Updated At:</h5>
                    <p><?php echo Carbon\Carbon::parse($dead_cow->updated_at)->format('jS M Y , h:i A'); ?></p>
                </div>

                <div class="panel-footer">
                    <div class="buttons">
                        <a href="<?php echo e(route('dead-cow.index')); ?>" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp Go Back</a>
                        <a href="<?php echo e(route( 'dead-cow.edit', array( 'id'=> $dead_cow->id ) )); ?>" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                    </div>

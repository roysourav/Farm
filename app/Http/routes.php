...
//All Pdf route
    ...
    Route::group( ['prefix' => 'pdf', 'middleware' => 'auth' ], function(){
        ...
        Route::get('/cow', [ 'as' => 'cow.list.pdf', 'uses' => 'pdfController@cowList' ] );
        Route::get('/cow/{id}', [ 'as' => 'show.cow.pdf', 'uses' => 'pdfController@cowShow' ] );
        ...
        Route::get('/reproduction', [ 'as' => 'reproduction.list.pdf', 'uses' => 'pdfController@reproductionList' ] );
        Route::get('/reproduction/{id}', [ 'as' => 'show.reproduction.pdf', 'uses' => 'pdfController@reproductionShow' ] );
        ...
        Route::get('/medicine', [ 'as' => 'medicine.list.pdf', 'uses' => 'pdfController@medicineList' ] );

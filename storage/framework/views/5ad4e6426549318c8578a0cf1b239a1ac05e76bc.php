                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-9">
                                    <?php echo Form::open( array( 'route'=>'supplier.store', 'id'=>'form',  ) ); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <?php echo Form::text( 'additional_mobile_one', null, array( 'class'=>'form-control','placeholder'=>'Enter Mobile No.','data-parsley-type'=>'number','data-parsley-length'=>'[10, 10]','data-parsley-length-message'=>'This value should be exactly 10 characters long' ) ); ?> 
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <?php echo Form::text( 'additional_mobile_two', null, array( 'class'=>'form-control','placeholder'=>'Enter Mobile No.','data-parsley-type'=>'number','data-parsley-length'=>'[10, 10]','data-parsley-length-message'=>'This value should be exactly 10 characters long' ) ); ?> 
                                        ...
                                        <div class="col-sm-9">
                                            <div class="buttons">
                                                ...
                                                <?php echo Form::submit( 'Create New Supplier', array( 'class'=>'btn btn-success' ) ); ?>

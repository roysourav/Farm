    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                Edit Medicine : {{ $medicine->category->name }}
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-9">
                        {!! Form::model( $medicine, array( 'method'=>'put', 'route'=> array( 'medicine.update', $medicine->id ),'id'=>'form' ) ) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="cat_id" class="form-control" required="">
                                        <option  value="{{ $medicine->category->id }}" selected="{{$medicine->category->name}}">{{$medicine->category->name}}</option>
                            ...
                            <div class="form-group m_bottom_30">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class=" input-group">
                                        ...
                                        {!! Form::text( 'stock', 0, array( 'class'=>'form-control','placeholder'=>'Enter stock in unit','required'=> '','data-parsley-type'=>'number' ) ) !!}
                            ...
                            <div class="col-sm-9">
                                <div class="buttons">
                                    <a href="{{ route('medicine.index') }}" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i>&nbsp Go Back</a>
                                        ...
                                        {!! Form::submit( '&#10004; Edit Medicine', array( 'class'=>'btn btn-warning' ) ) !!}
                                </div>
